...
public class PostController {
    ...
    public List<Post> getByAutor(@PathVariable String nome, @PathVariable String sobrenome){
        return this.service.findByAutor(nome, sobrenome);
    }

    @GetMapping("titulo/{titulo}")
    public List<Post> getByAutor(@PathVariable String titulo){
    ...
    public List<Post> getByDataPublicacao(@PathVariable LocalDate data){
        return this.service.findByDataPublicacaoMaiorOuIgual(data);
    }
